...
public class PengumumanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.pengumuman_fragment,container,false);
        ...
        adapter = new ListPengumumanAdapter(getActivity(),list);
        ...
        AsyncTask<Integer,Void,Void> task =new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                try {
                    ...
                    JSONArray array = object.getJSONArray("pengumuman");
                    for (int i=0;i<array.length();i++){
                        JSONObject obj = array.getJSONObject(i);
                        ListPengumuman pengumuman = new ListPengumuman(obj.getString("judul"),obj.getString("link"),obj.getString("tanggal"));
                        list.add(pengumuman);
                    }
